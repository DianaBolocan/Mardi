...
class MyAgent:
    def __init__(self):
        ...
        self.model.add(Dense(9, input_dim=2, activation="relu"))
    ...
    def getAction(self, state):
        return self.model.predict(state.reshape(1, 2))
...
def closestWallDirection(current_state, screen_size, direction):
